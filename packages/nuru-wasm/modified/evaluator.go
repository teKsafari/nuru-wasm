...
// func newError(format string, a ...interface{}) string {
func newError(format string, a ...interface{}) *object.Error {
	fmt.Println(object.Error{Message: fmt.Sprintf(format, a...)})
	return &object.Error{Message: fmt.Sprintf(format, a...)}
	// return fmt.Sprintf(format, a...) // changed to return string instead of *object.Error.
	// The change was made because the error came into js-land with unknown characters
	// Errors would show up with ? and other weird symbols.
	// Temp solution
	// TODO: Revisit formatted errors arriving weirdly in js-land
	// related change: assignEqual.go:10
